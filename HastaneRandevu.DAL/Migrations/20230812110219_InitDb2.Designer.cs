...
namespace HastaneRandevu.DAL.Migrations
{
    ...
    [Migration("20230812110219_InitDb2")]
            ...
            modelBuilder.Entity("HastaneRandevu.Entity.Concrete.Bolum", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 8, 12, 14, 2, 18, 967, DateTimeKind.Local).AddTicks(4354));
            ...
            modelBuilder.Entity("HastaneRandevu.Entity.Concrete.Doktor", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 12, 14, 2, 18, 967, DateTimeKind.Local).AddTicks(6770));
            ...
            modelBuilder.Entity("HastaneRandevu.Entity.Concrete.Hasta", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 12, 14, 2, 18, 967, DateTimeKind.Local).AddTicks(8271));
            ...
            modelBuilder.Entity("HastaneRandevu.Entity.Concrete.Randevu", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 12, 14, 2, 18, 967, DateTimeKind.Local).AddTicks(9700));
